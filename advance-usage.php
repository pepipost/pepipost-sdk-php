...
$body->personalizations[0]->to[0]->name = 'Vikram Sahu';
$body->personalizations[0]->to[0]->email = 'snipperbytes@gmail.com';


$body->personalizations[0]->cc = array();
$body->personalizations[0]->cc[0] = new Models\EmailStruct;
$body->personalizations[0]->cc[0]->name = 'Vikram';
$body->personalizations[0]->cc[0]->email = 'vikramsahu36@gmail.com';
...
$body->personalizations[0]->bcc[0]->email = 'vikram@pepipost.com';
