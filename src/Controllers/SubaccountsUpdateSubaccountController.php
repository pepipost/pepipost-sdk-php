 ...
 */
class SubaccountsUpdateSubaccountController extends BaseController
{
    /**
     * @var SubaccountsUpdateSubaccountController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SubaccountsUpdateSubaccountController The *Singleton* instance.
     */
     ...
     *
     * @param Models\Updatesubaccount $body Update sub account
     * @return object response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSubaccountsUpdateSubaccountPOST(
        $body
    ) {

        //prepare query string for API call
        $_queryBuilder = '/subaccounts/updateSubaccount';
