 ...
 */
class SubaccountsDeleteController extends BaseController
{
    /**
     * @var SubaccountsDeleteController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SubaccountsDeleteController The *Singleton* instance.
     */
     ...
     *
     * @param Models\Deletesubacoount $body delete subaccount
     * @return object response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function deleteSubaccountsDeleteDELETE(
        $body
    ) {

        //prepare query string for API call
        $_queryBuilder = '/subaccounts/delete';
