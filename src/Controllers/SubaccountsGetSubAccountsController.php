 ...
 */
class SubaccountsGetSubAccountsController extends BaseController
{
    /**
     * @var SubaccountsGetSubAccountsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return SubaccountsGetSubAccountsController The *Singleton* instance.
     */
     ...
     */
    public function getSubaccountsGetSubAccountsGET(
        $limit,
        $offset
    ) {

        //prepare query string for API call
        $_queryBuilder = '/subaccounts/getSubAccounts';
